...
Core/KEY/%.o Core/KEY/%.su Core/KEY/%.cyclo: ../Core/KEY/%.c Core/KEY/subdir.mk
...
clean: clean-Core-2f-KEY

clean-Core-2f-KEY:
	-$(RM) ./Core/KEY/key.cyclo ./Core/KEY/key.d ./Core/KEY/key.o ./Core/KEY/key.su

.PHONY: clean-Core-2f-KEY
